...
class Victorine {
    ...
    loadQuizForAircraft(aircraftId) {
        const quizzes = {
            ...
            'tu22m3': {
                title: 'Викторина по Ту-22М3 "Ответный удар"',
                questions: [
                    {
                        question: 'Какое основное назначение Ту-22М3?',
                        options: [
                            'Дальний перехватчик',
                    ...
                    {
                        question: 'Какова максимальная скорость Ту-22М3?',
                        options: [
                            '1800 км/ч',
                            '2000 км/ч', 
                            '2300 км/ч',
                    ...
                    {
                        question: 'Какая особенность крыла Ту-22М3?',
                        options: [
                            'Фиксированное крыло',
                            'Стреловидное крыло', 
                    ...
                    {
                        question: 'Какое основное вооружение несет Ту-22М3?',
                        options: [
                    ...
                    {
                        question: 'Какой двигатель установлен на Ту-22М3?',
                        options: [
                            'НК-25',
                            'АЛ-31Ф', 
                            'РД-33',
                    ...
                    {
                        question: 'Какой экипаж у Ту-22М3?',
                        options: [
                            '1 пилот',
                            '2 человека (пилот и штурман)', 
                            '3 человека (пилот, штурман и оператор вооружения)',
                            '4 человека (пилот, второй пилот, штурман и оператор)'
                        ],
                        answer: 3
                    },
                    {
                        question: 'В каком году Ту-22М3 поступил на вооружение?',
                        options: [
                            '1969',
                            '1976', 
                            '1983',
                    ...
                    {
                        question: 'Какова максимальная боевая нагрузка Ту-22М3?',
                        options: [
                            '12 000 кг',
                            '18 000 кг', 
                            '24 000 кг',
            ...
            'su57': {
                title: 'Викторина по Су-57 "Фельдмаршал"',
                questions: [
                    {
            ...
            'su34': {
                title: 'Викторина по Су-34 "Утенок"',
                questions: [
                    {
            ...
            'su35': {
                title: 'Викторина по Су-35С "Фланкер-Э"',
                questions: [
                    {
                        question: 'В каком году Су-35С был принят на вооружение ВКС России?',
                        options: ['2010', '2012', '2014', '2016'],
                        answer: 2
                    },
                    {
                        question: 'Какой двигатель установлен на Су-35С?',
                        options: ['АЛ-31Ф', 'АЛ-41Ф1С', 'РД-33', 'ПС-90А'],
                        answer: 1
                    },
                    {
                        question: 'Какая уникальная особенность двигателей Су-35С?',
                        options: [
                            'Реверс тяги',
                    ...
                    {
                        question: 'Как называется РЛС Су-35С?',
                        options: [
                            'Ирбис-Э',
                            'Н035', 
                            'Барс',
                    ...
                    {
                        question: 'Какова максимальная скорость Су-35С?',
                        options: [
                            '2000 км/ч',
                            '2300 км/ч', 
                            '2500 км/ч',
                    ...
                    {
                        question: 'Сколько точек подвески вооружения имеет Су-35С?',
                        options: [
                            '8',
                            '10', 
                            '12',
                    ...
                    {
                        question: 'Какой маневр демонстрирует сверхманевренность Су-35С?',
                        options: [
                            'Кобра Пугачёва',
                            'Колокол', 
                            'Хук',
                    ...
                    {
                        question: 'Какое максимальное количество ракет "воздух-воздух" может нести Су-35С?',
                        options: [
                            '8',
                            '10', 
                            '12',
                    ...
                    {
                        question: 'Какой тип БРЭО используется на Су-35С?',
                        options: [
                            'Цифровая электродистанционная система управления',
                    ...
                    {
                        question: 'Какова максимальная боевая нагрузка Су-35С?',
                        options: [
                            '6000 кг',
                            '8000 кг', 
                            '10000 кг',
